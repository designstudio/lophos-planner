...
export default function SignUpForm() {
    ...
    return (
        <Blur type="signup-form">
            <div
                className="signup-form relative top-4 z-20 mx-auto w-full max-w-[512px] rounded-[24px] bg-[rgb(250,250,252)] p-6 text-black shadow-lg outline-none"
            ...
            >
                ...
                <Form method="POST" className="relative" action="/signup">
                    ...
                    <button
                        ...
                        className="mt-6 inline-flex h-12 w-full items-center justify-center rounded-full bg-black px-6 text-base font-bold text-white transition-opacity duration-150 hover:opacity-90 disabled:cursor-default disabled:opacity-20"
                    >
